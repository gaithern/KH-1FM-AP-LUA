...
-- categories for the items, used for the popup upper right
item_categories = {
  equipment  = 0,
  consumable = 1,
  unlock     = 2,
...
-- cache for stuff that should be shown to the user grouped by category
message_cache = {
  items = {},
  sent  = {},
  debug = {},
...
-- maps and human readable name for an integer,
-- that integer applied to the colour memory as offset controls the colour of the prompt
prompt_colours = {
  blue_donald      = -8,
  green_goofy      = -4,
  red_sora         = 0,
...
-- category of the importance of an item
item_usefulness = {
  trap        = 0,
  useless     = 1,
  normal      = 2,
...
function GetKHSCII(INPUT)
  local _charTable = {
    [' '] =  0x01, ['\n'] =  0x02, ['-'] =  0x6E, ['!'] =  0x5F, ['?'] =  0x60, ['%'] =  0x62,
    ['/'] =  0x66, ['.'] =  0x68,  [','] =  0x69, [';'] =  0x6C, [':'] =  0x6B, ['\'']=  0x71,
    ['('] =  0x74, [')'] =  0x75,  ['['] =  0x76, [']'] =  0x77, ['¡'] =  0xCA, ['¿'] =  0xCB,
    ['À'] =  0xCC, ['Á'] =  0xCD,  ['Â'] =  0xCE, ['Ä'] =  0xCF, ['Ç'] =  0xD0, ['È'] =  0xD1,
    ['É'] =  0xD2, ['Ê'] =  0xD3,  ['Ë'] =  0xD4, ['Ì'] =  0xD5, ['Í'] =  0xD6, ['Î'] =  0xD7,
    ['Ï'] =  0xD8, ['Ñ'] =  0xD9,  ['Ò'] =  0xDA, ['Ó'] =  0xDB, ['Ô'] =  0xDC, ['Ö'] =  0xDD,
    ['Ù'] =  0xDE, ['Ú'] =  0xDF,  ['Û'] =  0xE0, ['Ü'] =  0xE1, ['ß'] =  0xE2, ['à'] =  0xE3,
    ['á'] =  0xE4, ['â'] =  0xE5,  ['ä'] =  0xE6, ['ç'] =  0xE7, ['è'] =  0xE8, ['é'] =  0xE9,
    ['ê'] =  0xEA, ['ë'] =  0xEB,  ['ì'] =  0xEC, ['í'] =  0xED, ['î'] =  0xEE, ['ï'] =  0xEF,
    ['ñ'] =  0xF0, ['ò'] =  0xF1,  ['ó'] =  0xF2, ['ô'] =  0xF3, ['ö'] =  0xF4, ['ù'] =  0xF5,
    ['ú'] =  0xF6, ['û'] =  0xF7,  ['ü'] =  0xF8
  }
...
--translates a usefulness value to a colour
function usefulness_to_colour(usefulness)
  ...
  ConsolePrint("Error: usefulness_to_colour() called with invalid usefulness value: " .. usefulness)
  return prompt_colours.red_sora;
end

--wrapper for _show_prompt_ to correctly displays the prompt according the items metadata
function show_prompt_for_item(item)
  ...
  --should probably merge that with the statement below
...
--wrapper for _show_prompt_ to correctly displays the prompt for an item sent in a multiworld
function show_prompt_for_sent(msg)
  local info = {
    item = msg[1],
    reciver = msg[2],
  ...
  --"Link's Ocarina", "James' Heat Badge", etc.
...
-- Display the "Level Up" pop up and swaps out a few values for custom ones.
--   -_input_title_: Upper Right Corner Text
--   -_input_party_: lower text
--   -_duration_: how long the pop up stays on screen
--   -_colour_: colour of the pop up as an offset, defaults to red
function show_prompt(input_title, input_party, duration, colour)
  ...
  for z = 1, 3 do
    ...
    local _colorText = 0x01840CA + colour     -- 1 for black
...
-- Shows the first of the queues messages.
-- If there are no messages in the queue, nothing happens.
-- If there are messages in the queue, the first message is shown and removed from the queue.
-- Returns after one message is shown.
-- Returns nothing.
function handle_messages()

  -- KH1 recieved an item
